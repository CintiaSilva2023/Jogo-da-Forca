function criaCampo() { 
    ...
    btn1.innerHTML = '<textarea maxlength="8" name="" id="campo" placeholder="Digite uma palavra"></textarea>';
    btn2.innerHTML += '<div class="aviso"><img src="img/icone.png" alt="icone de informação" width="12px" height="12px"><p>Max. de 8 letras.</p></div>';
